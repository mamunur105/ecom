                                ...
                                <div class="row">
                                    <div class="col-xl-6 ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="title" type="text" id="projectname" class="form-control" placeholder="Enter project name" value="{{ $post->title }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="project-overview">Content</label>
                                            <textarea name="content" class="form-control" id="project-overview" rows="5" placeholder="Enter some brief about project..">{{ $post->content }}</textarea>
                                        </div>
                                        <!-- Date View -->
                                        <div class="form-group ">
                                            <label for="project-overview">Category</label>
                                            <select class="form-control select2" data-toggle="select2" value="{{ $post->category_id }}">
                                        ...
                                        <div class="form-group ">
                                            <select name="status" class="form-control select2" data-toggle="select2" value="{{ $post->category_id }}">
                                                <option>---Select---</option>
